...
BOOST_AUTO_TEST_CASE( constraint_differ_string)
{
   ...
   // constraint is not checked since only one argument is used
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-p server1"));
   } // end scope
   ...
   // constraint is successfully checked
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-p server1 -b server2"));
   } // end scope
   ...
   // constraint complains
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b")));
      BOOST_REQUIRE_THROW( evalArgumentString( ah, "-p server1 -b server1"),
         std::runtime_error);
   } // end scope
...
BOOST_AUTO_TEST_CASE( constraint_differ_int)
{
   ...
   // constraint is not checked since only one argument is used
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-p 13"));
   } // end scope
   ...
   // constraint is not checked since only one argument is used
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-b 42"));
   } // end scope
   ...
   // constraint is successfully checked
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-p 13 -b 42"));
   } // end scope
   ...
   // constraint complains
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b")));
      BOOST_REQUIRE_THROW( evalArgumentString( ah, "-p 13 -b 13"),
         std::runtime_error);
   } // end scope
...
BOOST_AUTO_TEST_CASE( constraint_differ_int3)
{
   ...
   // constraint is not checked since only one argument is used
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b;q")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-q 4711"));
   } // end scope
   ...
   // constraint is successfully checked with 1 and 3
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b;q")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-p 13 -q 4711"));
   } // end scope
   ...
   // constraint is successfully checked with 2 and 3
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b;q")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-b 42 -q 4711"));
   } // end scope
   ...
   // constraint is successfully checked with 1, 2 and 3
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b;q")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "-p 13 -b 42 -q 4711"));
   } // end scope
   ...
   // constraint complains
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( differ( "p;b;q")));
      BOOST_REQUIRE_THROW( evalArgumentString( ah, "-p 13 -b 42 -q 13"),
         std::runtime_error);
   } // end scope
...
BOOST_AUTO_TEST_CASE( constraint_disjoint_int)
{
...

   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( disjoint( "one;two")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "--one 1"));
   } // end scope

   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( disjoint( "one;two")));
      BOOST_REQUIRE_NO_THROW( evalArgumentString( ah, "--one 1 --two 2"));
   } // end scope

   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addConstraint( disjoint( "one;two")));
      BOOST_REQUIRE_THROW( evalArgumentString( ah, "--one 1,3 --two 2,3"),
         std::runtime_error);
   } // end scope
