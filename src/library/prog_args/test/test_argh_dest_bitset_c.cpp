...
BOOST_AUTO_TEST_CASE( test_bitset_errors)
{
   ...
   // try to set a bit that is outside the range of the bitset
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addArgument( "b", DEST_VAR( b), "values"));
      BOOST_REQUIRE_THROW( evalArgumentString( ah, "-b 10"), std::runtime_error);
   } // end scope
   ...
   // try to set a bit that is outside the range of the bitset
   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addArgument( "b", DEST_VAR( b), "values"));
      BOOST_REQUIRE_THROW( evalArgumentString( ah, "-b 3,25"),
         std::runtime_error);
   } // end scope
   ...
   // enum value is out of range
   {
      ...
      BOOST_REQUIRE_THROW( evalArgumentString( ah, "-b first,tenth"),
         std::runtime_error);
   } // end scope
...
BOOST_AUTO_TEST_CASE( list_var)
{
   ...
   BOOST_REQUIRE_NO_THROW(
      evalArgumentString( ah, "--list-arg-var -b 4,5,6 --list-arg-var"));
