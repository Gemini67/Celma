...
static void printUsage( int flags, int argc, char* argv[]);
...
int main( int argc, char* argv[])
{
   ...
   printUsage( prog_args::Handler::hfHelpShort | prog_args::Handler::hfUsageHidden | prog_args::Handler::hfUsageCont,
               argc, argv);
...
static void printUsage( int flags, int argc, char* argv[])
{
   ...
   try
   {
      ...
      ah.addArgument( "int-man",           DEST_VAR( intArgMan), "integer mandatory")->setIsMandatory();
      ah.addArgument( "string-opt",        DEST_VAR( stringArgOpt), "string optional");
      ah.addArgument( "string-man",        DEST_VAR( stringArgMan), "string mandatory")->setIsMandatory();
      ah.addArgument( "hidden-flag",       DEST_VAR( hiddenFlagArg),   "hidden flag")->setIsHidden();
      ah.addArgument( "hidden-int-opt",    DEST_VAR( hiddenIntArgOpt), "hidden integer optional")->setIsHidden();
      ah.addArgument( "hidden-int-man",    DEST_VAR( hiddenIntArgMan), "hidden integer mandatory")->setIsMandatory()->setIsHidden();
      ah.addArgument( "hidden-string-opt", DEST_VAR( hiddenStringArgOpt), "hidden string optional")->setIsHidden();
      ah.addArgument( "hidden-string-man", DEST_VAR( hiddenStringArgMan), "hidden string mandatory")->setIsMandatory()->setIsHidden();
