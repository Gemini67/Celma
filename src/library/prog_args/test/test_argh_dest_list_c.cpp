...
/// Test constraint "disjoint" with two lists.
///
/// @since  x.y.z, 05.07.2020
BOOST_AUTO_TEST_CASE( disjoint_lists)
{
...

   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addArgument( "l", DEST_VAR( l1), "left"));
      BOOST_REQUIRE_NO_THROW( ah.addArgument( "r", DEST_VAR( l2), "right"));
