...
/// Test constraint "disjoint" with two unordered multi-sets.
///
/// @since  x.y.z, 05.07.2020
BOOST_AUTO_TEST_CASE( disjoint_unordered_multisets)
{
...

   {
      ...
      BOOST_REQUIRE_NO_THROW( ah.addArgument( "l", DEST_VAR( ums1), "left"));
      BOOST_REQUIRE_NO_THROW( ah.addArgument( "r", DEST_VAR( ums2), "right"));
   ...
   // throw if the data in the unordered multisets is not disjoint
   {
      Handler                        ah( 0);
      std::unordered_multiset< int>  ums1;
      std::unordered_multiset< int>  ums2;
