...
/// argument format (character), the long format (string/name) or both.
///
...
public:
   ...
   /// @since
   ///    0.2, 10.04.2016
   explicit ArgumentContainer( bool stores_sub_args = false);
   ...
   /// @since  0.2, 10.04.2016
   void add( TypedArgBase* argHandler, const ArgumentKey& key);
