...
/// @file
/// See documentation of class celma::log::detail::IDuplicatePolicy.


#ifndef CELMA_LOG_DETAIL_I_DUPLICATE_POLICY_HPP
#define CELMA_LOG_DETAIL_I_DUPLICATE_POLICY_HPP
...
#endif   // CELMA_LOG_DETAIL_I_DUPLICATE_POLICY_HPP
