...
#ifndef CELMA_CONTAINERS_BTREE_HPP
#define CELMA_CONTAINERS_BTREE_HPP
...
public:
   ...
   public:
      ...
      inline self& operator ++( std::prefix)
      {
      ...
      inline self operator ++( std::postfix)
      {
   ...
   public:
      ...
      inline const_iterator( const typename btree::LeafNode* l,
         unsigned short s)
          : mpCurrentNode( l), mCurrentSlot( s)
      { }
   ...
   public:
      ...
      inline const_reverse_iterator( const typename btree::LeafNode* l,
         unsigned short s)
          : mpCurrentNode( l), mCurrentSlot( s)
      { }
...
private:
   ...
   inline InnerNode* allocate_inner( unsigned short level)
   {
...
public:
   ...
   /// present.
   inline insert_result_t insert( const pair_type& x)
   {
   ...
   inline insert_result_t insert( const key_type& key, const data_type& data)
   {
   ...
   inline insert_result_t insert2( const key_type& key, const data_type& data)
   {
      return insert_start( key, data);
   }
...
private:
   ...
   inline const LeafNode* findLeaf( const key_type& key) const
   {
      const Node*  n = mpRoot;
      if (n == nullptr)
         return nullptr;
