...
public:
   ...
   ///
   /// @param[in]  obj
   ///    Pointer to the object to iterate over.
   /// @param[in]  pos
   ...
   /// @return
   ///    \c true if both objects handle the same string, and this object points
   ///    to a position before that of the other object, or both point to the
   ///    same position.
   /// @since  1.46.0, 20.01.2021
   bool operator <=( const FixedStringIterator& other) const noexcept;
   ...
   /// @return
   ///    \c true if both objects handle the same string, and this object points
   ///    to a position after that of the other object, or both point to the
   ///    same object.
   /// @since  1.46.0, 20.01.2021
   bool operator >=( const FixedStringIterator& other) const noexcept;
   ...
   /// @return
   ///    \c true if both objects handle the same string, and this object points
   ///    to a position after that of the other object.
   /// @since  1.46.0, 20.01.2021
   bool operator >( const FixedStringIterator& other) const noexcept;
   ...
   /// @return  This object.
   /// @since  1.46.0, 20.01.2021
   FixedStringIterator& operator ++( std::prefix);
   ...
   /// @since  1.46.0, 20.01.2021
   FixedStringIterator operator ++( std::postfix);
