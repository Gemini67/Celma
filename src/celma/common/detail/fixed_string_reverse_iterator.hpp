...
public:
   ...
   ///          points to a position behind that of the other object.
   /// @since  x.y.z, 21.01.2021
   bool operator <( const FixedStringReverseIterator& other) const noexcept;
   ...
   /// @param[in]  other  The other object to compare against.
   /// @return  \c true if both objects handle the same string, and this object
   ///          points to the same position or a position behind that of the
   ///          other object.
   /// @since  x.y.z, 21.01.2021
   bool operator <=( const FixedStringReverseIterator& other) const noexcept;
   ...
   /// @param[in]  other  The other object to compare against.
   /// @return  \c true if both objects handle the same string, and this object
   ///          points to the same position, or a position before that of the
   ///          other object.
   /// @since  x.y.z, 21.01.2021
   bool operator >=( const FixedStringReverseIterator& other) const noexcept;
   ...
   /// @return  This object.
   /// @since  x.y.z, 21.01.2021
   FixedStringReverseIterator& operator ++();
   ...
   ///                  increment operators.
   /// @return  Reverse iterator pointing to the previous position of this
   ///          iterator.
   /// @since  x.y.z, 21.01.2021
   FixedStringReverseIterator operator ++( int);
