...
/// @file
/// See documentation of template class celma::common::detail::GeneratorIterator<>.
...
/// Iterator for a range of generated numbers.
///
/// @tparam  G
///    Type of the generator object.
/// @since  x.y.z, 15.05.3023
template< typename G> class GeneratorIterator
{
public:
   /// Constructor.
   ///
   ...
   explicit GeneratorIterator( R* random, size_t num_values = 0);
   ...
   /// @since  1.45.0, 23.01.2021
   GeneratorIterator& operator ++( std::prefix);

   /// Postfix increment operator.
   ///
   /// @return  Iterator object with the previous random number.
   /// @since  1.45.0, 23.01.2021
   GeneratorIterator operator ++( std::postfix);
...
}; // GeneratorIteratorRandomRangeIter
