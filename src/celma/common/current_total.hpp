...
///
/// @tparam  N  Number of counters to maintain.
/// @tparam  T  Type of the counters.
...
public:
   ...
   ///
   /// @param[in]  idx
   ///    Index of the counter to increment, in the range 0..N-1.
   /// @param[in]  add
   ...
   ///
   /// @param[in]  idx
   ///    Index of the counter to return the current value of, in the range
   ///    0..N-1.
   /// @return  Current value of the counter with the given index.
   /// @since  1.13.0, 07.09.2018
   ...
   /// @return  Current value of the counter with the given index.
   /// @since  1.13.0, 07.09.2018
   [[nodiscard]] T currentValue( int idx) const;

   /// Returns the total value of the counter with the given index.
   ///
   /// @param[in]  idx
   ///    Index of the counter to return the total of, in the range 0..N-1.
   /// @return  Total of the counter with the given index.
   /// @since  1.13.0, 07.09.2018
   [[nodiscard]] T totalValue( int idx) const;
   ...
   ///    added to the total.
   /// @param[in]  idx
   ///    Index of the value to add to the total in the range 0..N-1, -1 to
   ///    handle all counters.
   /// @since  1.13.0, 07.09.2018
   ...
   ///
   /// @param[in]  idx
   ///    Index of the counter to reset the current value of in the range
   ...
   ///
   /// @param[in]  idx
   ///    Index of the counter to reset the total of in the range 0..N-1,
   ...
   ///
   /// @param[in]  idx
   ///    Index of the counter to reset the current value, and the total of,
