...
public:
   ...
   /// Assigns the contents of another binary tree to this object.
   /// The speciality of this function is that it always creates a well balanced
   /// tree.
   ///
...
template< typename T, typename C>
   typename BinaryTree< T, C>::const_iterator BinaryTree< T, C>::begin() const
{
...
template< typename T, typename C>
   typename BinaryTree< T, C>::const_iterator BinaryTree< T, C>::end() const
{
   return const_iterator();
} // BinaryTree< T, C>::end
...
template< typename T, typename C>
   typename BinaryTree< T, C>::const_reverse_iterator BinaryTree< T, C>::rbegin() const
{
   return mpRoot ? const_reverse_iterator( mpRoot->last()) : const_reverse_iterator();
} // BinaryTree< T, C>::rbegin
...
template< typename T, typename C>
   typename BinaryTree< T, C>::const_reverse_iterator BinaryTree< T, C>::rend() const
{
   return const_reverse_iterator();
} // BinaryTree< T, C>::rend
...
template< typename T, typename C>
   auto BinaryTree< T, C>::recursiveInsert( node_t* parent_node,
                                            const T& new_value)
{
